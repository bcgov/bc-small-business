              ...
              tabItem(
                ...
                fluidRow(
                  box(
                    ...
                    fluidRow(
                      box(
                        title = HTML("<small><p><b>Definitions:</b></small>"),
                        collapsible = TRUE,
                        collapsed = TRUE,
                  ...
                  box(
                    ...
                    fluidRow(
                      box(
                        ...
                        collapsible = TRUE,
                        collapsed = TRUE,
                        HTML("<small>Industries in this chart are grouped using the North American Industry Classification System (NAICS).
                  ...
                  box(
                    ...
                    fluidRow(
                      box(
                        ...
                        collapsible = TRUE,
                        collapsed = TRUE,
                        HTML("<small><b><p><i>Tourism</i></b> includes industries such as transportation, accommodation, food services and other tourism related activities. Further information on the tourism sector is available at BC Stats.
                  ...
                  box(
                    ...
                    width = 10,
                    HTML("<p><small><i>This chart shows the number of small businesses per 1,000 people by province.</i></small>"),
                  ...
                  box(
                    ...
                    width = 10,
                    HTML("<p><small><i>This chart illustrates the annual change in the number of small business for each province. </i></small>"),
                  ...
                  box(
                    ...
                    width = 10,
                    HTML("<p><small><i>This chart provides a detailed view of small business and population distributions around British Columbia.</i></small>"),
                    plotOutput("plot1.12", height = "470px"),
                    br(),
                    HTML("<b><small></b> <p><b>Source:</b> BC Stats using data supplied by Statistics Canada.</small>")
                  ),
                  box(
                    ...
                    width = 10,
                    HTML("<p><small><i>This chart shows the number of small business per 1,000 people by development region in British Columbia.</i></small>"),
                  ...
                  box(
                    ...
                    width = 10,
                    HTML("<p><small><i>This chart shows the number of small businesses by development region in British Columbia.</i></small>"),
                    plotlyOutput("plot1.14"),
                    br(),
                    HTML("<b><small></b><p><b>Note:</b> Figures do not add to the total because the provincial total
                  ...
                  box(
                    ...
                    HTML("<p><small><i>This chart shows the net annual change in the number of small businesses by development region in British Columbia.
                                          That is, the difference between the number of small businesses between the latest annual data and the previous year. </i></small>"),
              ...
              tabItem(
                ...
                fluidRow(
                    ...
                    fluidRow(
                      box(
                        ...
                        HTML("<small><b><i>Public sector employees </b></i>are employees in public administration at the federal, provincial, territorial, municipal, First Nations and other Indigenous governments as well as in Crown corporations, liquor control boards, and other government institutions such as schools (including universities), hospitals and public libraries.
                                                ...
                                                or other government controlled business such as Crown corporations, liquor control boards, public education, hospitals and public libraries.</small>")
                      )
                    )
                  ),
                  box(
                  ...
                  box(
                    ...
                    width = 10,
                    HTML("<p><small><i>This chart shows the five industries with the largest rate of employment growth in the last five years in British Columbia. It also shows the five industries with the lowest rate of employment growth in the last five years.</i></small>"),
                    plotlyOutput("plot2.10"),
                    br(),
                    HTML("<b><small><p>Note:</b> Public administration employment here measures small government entities such as small municipal and Indigenous government organizations.
                                                <p><b>Source:</b> BC Stats using data supplied by Statistics Canada.</small>")
                  ),
                  box(HTML("<b><center>Feedback:</b> SmallBusinessBranch@gov.bc.ca </center>"),
                    width = 10
                  )
              )), ## page 2 tab end ----
              ## page 3 tab start ----
              ...
              tabItem(
                ...
                fluidRow(
                    ...
                    fluidRow(
                      box(
                        ...
                        HTML("<small><b><i>Self-employed </b></i>are persons whose job consisted mainly of operating a business,
                                                  farm or professional practice, alone or in partnership.</small>")))),
                  box(
                  ...
                  box(
                    ...
                    HTML("<b><small></b> <p><b>Source:</b> BC Stats using data supplied by Statistics Canada.</small>"),
                    fluidRow(
                      box(title = HTML("<small><p><b>Definitions:</b></small>"),
                          collapsible = TRUE,
                          collapsed = TRUE,
                          HTML("<small><b><i>Self-employed </b></i>are persons whose job consisted mainly of operating a business,
                                                  farm or professional practice, alone or in partnership.</small>")))),
                    ...
                    fluidRow(
                      box(title = HTML("<small><p><b>Definitions:</b></small>"),
                          ...
                          HTML("<small><b><i>Incorporated businesses </b></i>consist of those organized and maintained as legal corporations. A corporation is created (incorporated) by
                                                  one or more shareholders who have ownership of the corporation, represented by their holding of common stock.<p>
                                                  <b><i>Unincorporated businesses </b></i>consist of those not organized and maintained as legal corporations, and wherein the tie between members need not be a legally enforceable contract.<p></small>")))),
                  box(
                  ...
                  box(
                    ...
                    width = 10,
                    HTML("<p><small><i>This chart compares the number of self-employed persons with paid help and those without paid help for selected years.</i></small>"),
                    plotlyOutput("plot3.6"),
                    br(),
                    HTML("<b><small>Note:</b> Excludes unpaid family workers<p><b>Source:</b> Statistics Canada / Prepared by BC Stats.</small>")),
                  box(
                  ...
                  box(
                    ...
                    fluidRow(
                      box(title = HTML("<small><p><b>Definition:</b></small>"),
                          collapsible = TRUE,
                          collapsed = TRUE,
                          HTML("<small><b>Usual work hours</b> refers to the employed person's normal paid or contract hours, not counting any overtime.</small>"))))
              ...
              tabItem(
                ...
                fluidRow(
                  box(
                    ...
                    width = 10,
                    HTML("<p><small><i>This chart shows shows the proportion of self-employed persons who identify as women by province.</i></small>"),
                  ...
                  box(
                    ...
                    width = 10,
                    HTML("<p><small><i>This chart shows the proportion of self-employed persons who identify as women by development region.</i></small>"),
                  ...
                  box(
                    ...
                    width = 10,
                    HTML("<p><small><i>This chart compares the number of usual hours worked per week for self-employed persons by sex.</i></small>"),
              ...
              tabItem(
                ...
                fluidRow(
                  box(
                    ...
                    width = 10,
                    HTML("<p><small><i>This chart shows persons who are self-employed as a percentage of total employment for off-reserve Indigenous and Non-Indigenous populations.</i></small>"),
                    ...
                    fluidRow(
                      box(title = HTML("<small><p><b>Definitions:</b></small>"),
                          collapsible = TRUE,
                          collapsed = TRUE,
                      HTML("<small><b><i>Indigenous Persons </b></i>are those who indicate that they identify as an Indigenous person, and/or are registered under the Indian Act, and/or are a member of a First Nation or Indian band.<p>
                                                  <b><i>Off reserve </b></i>includes all census subdivisions in Canada not legally affiliated with First Nations or Indian bands.<p></small>"))))
              ...
              tabItem(
                ...
                fluidRow(
                  ...
                  box(
                    ...
                    HTML("<b><small></b> <p><b>Source:</b> BC Stats using data supplied by Statistics Canada.</small>"),
                    fluidRow(box(
                      title = HTML("<small><p><b>Definition:</b></small>"),
                      collapsible = TRUE,
                      collapsed = TRUE,
                      HTML("<small><b><i>Average annual earnings </b></i> refers to the gross taxable payroll of an employee,
                                                expressed on an annual basis, including pay for overtime.<p></small>")))),
                  box(
                    ...
                    fluidRow(box(
                      ...
                      collapsible = TRUE,
                      collapsed = TRUE,
                      HTML("<small><b><i>Payroll </b></i> includes regular pay, overtime and bonuses, commissions and all other types of special payments. The payroll concept excludes dollar
                                                  amounts that are taxable allowances and benefits, certain types of non-wage compensation, as well as employer contributions to employment insurance,
                                                  Canada and Quebec pension plans, provincial medical plans, workers’ compensation and other welfare plans.<p></small>")))),
                ...
                fluidRow(
                  ...
                  box(
                    ...
                    fluidRow(box(
                      ...
                      collapsible = TRUE,
                      collapsed = TRUE,
                      HTML("<small>An <b><i>exporter</b></i> is defined as an enterprise that sells goods out of the country, regardless of the value of exports.<p></small>")))),
                  box(
                ...
                fluidRow(
                  box(
                    ...
                    fluidRow(box(
                      ...
                      collapsible = TRUE,
                      collapsed = TRUE,
                      HTML("<small><p>The lower small business tax rate is applicable to Canadian-controlled private corporations (CCPCs) with active business income eligible for the federal small business deduction. One component of the small business deduction is the business limit.
                  ...
                  box(
                    ...
                    fluidRow(box(
                      ...
                      collapsible = TRUE,
                      collapsed = TRUE,
                      HTML("<small><p>Bankruptcy is a legal process performed under the Bankruptcy and Insolvency Act. A business' assets are assigned to a licence trustee because of inability to pay debts. A business bankruptcy is chiefly attributable to the liabilities incurred as a result of
  ...
  output$plot3.3a <- renderPlotly({
    ...
    plot_ly(plot_data,
      ...
      layout(
        ...
        xaxis = list(title = "", tickformat = "0%"),
        yaxis = list(title = "", autorange = "reversed"),
        shapes = list(vline(canada_average))
      ) %>% ## add line
      add_annotations( ## add canadian average text
        x = 0.25,
        y = .99,
